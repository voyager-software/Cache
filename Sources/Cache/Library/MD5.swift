...
final class MD5 {
    ...
    private static func hex_md5(_ input: String) -> String {
        return rstr2hex(rstr_md5(str2rstr_utf8(input)))
    }
    
    private static func str2rstr_utf8(_ input: String) -> [CUnsignedChar] {
        return Array(input.utf8)
    }
    
    private static func rstr2tr(_ input: [CUnsignedChar]) -> String {
        var output: String = ""
     ...
     */
    private static func rstr2hex(_ input: [CUnsignedChar]) -> String {
     ...
     */
    private static func rstr2binl(_ input: [CUnsignedChar]) -> [Int32] {
     ...
     */
    private static func binl2rstr(_ input: [Int32]) -> [CUnsignedChar] {
     ...
     */
    private static func rstr_md5(_ input: [CUnsignedChar]) -> [CUnsignedChar] {
     ...
     */
    private static func safe_add(_ x: Int32, _ y: Int32) -> Int32 {
        return x &+ y
    }
     ...
     */
    private static func bit_rol(_ num: Int32, _ cnt: Int32) -> Int32 {
        // num >>>
     ...
     */
    private static func md5_cmn(_ q: Int32, _ a: Int32, _ b: Int32, _ x: Int32, _ s: Int32, _ t: Int32) -> Int32 {
        return safe_add(bit_rol(safe_add(safe_add(a, q), safe_add(x, t)), s), b)
    }
    
    private static func md5_ff(_ a: Int32, _ b: Int32, _ c: Int32, _ d: Int32, _ x: Int32, _ s: Int32, _ t: Int32) -> Int32 {
        return md5_cmn((b & c) | ((~b) & d), a, b, x, s, t)
    }
    
    private static func md5_gg(_ a: Int32, _ b: Int32, _ c: Int32, _ d: Int32, _ x: Int32, _ s: Int32, _ t: Int32) -> Int32 {
        return md5_cmn((b & d) | (c & (~d)), a, b, x, s, t)
    }
    
    private static func md5_hh(_ a: Int32, _ b: Int32, _ c: Int32, _ d: Int32, _ x: Int32, _ s: Int32, _ t: Int32) -> Int32 {
        return md5_cmn(b ^ c ^ d, a, b, x, s, t)
    }
    
    private static func md5_ii(_ a: Int32, _ b: Int32, _ c: Int32, _ d: Int32, _ x: Int32, _ s: Int32, _ t: Int32) -> Int32 {
     ...
     */
    private static func binl_md5(_ input: [Int32], _ len: Int) -> [Int32] {
        /* append padding */
    ...
    private static func length(_ dictionary: [Int: Int32]) -> Int {
        return (dictionary.keys.max() ?? 0) + 1
    }
    
    private static func dictionary2array(_ dictionary: [Int: Int32]) -> [Int32] {
    ...
    private static func unwrap(_ value: Int32?, _ fallback: Int32 = 0) -> Int32 {
        if let value = value {
            return value
        }
    ...
    private static func zeroFillRightShift(_ num: Int32, _ count: Int32) -> Int32 {
